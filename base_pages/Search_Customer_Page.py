...
class Search_Customer_Page:
    ...
    def enter_customer_companyname(self,comp_name):
        ...
        self.driver.find_element(By.ID,self.text_company_id).send_keys(comp_name)
    ...
    def search_customer_by_email(self,email):
        ...
        for r in range(1,self.get_result_table_rows()+1):
            cust_email=self.driver.find_element(By.XPATH,"//table[@id='customers-grid']/tbody/tr["+str(r)+"]/td[2]").text
    ...
    def search_customer_by_name(self,name):
        ...
        for r in range(1,self.get_result_table_rows()+1):
            cust_name=self.driver.find_element(By.XPATH,"//table[@id='customers-grid']/tbody/tr["+str(r)+"]/td[3]").text
    ...
    def search_customer_by_company(self,company_name):
        ...
        for r in range(1,self.get_result_table_rows()+1):
            cump_name=self.driver.find_element(By.XPATH,"//table[@id='customers-grid']/tbody/tr["+str(r)+"]/td[5]").text

            if cump_name==company_name:
